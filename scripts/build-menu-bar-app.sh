...
plutil -replace CFBundleShortVersionString -string "${KATALK_AX_VERSION:-0.1.9}" "$APP_DIR/Contents/Info.plist"
plutil -replace CFBundleVersion -string "${KATALK_AX_BUILD_NUMBER:-9}" "$APP_DIR/Contents/Info.plist"
